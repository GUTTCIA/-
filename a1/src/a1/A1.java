...
public class A1 extends JFrame implements ActionListener {
    ...
    public A1() {
        setTitle("计算器");
        setSize(300, 300);//初始化窗口大小
        setResizable(true);//可调节窗口大小
        setLocationRelativeTo(null);//设置窗口相对位置，null：此窗口将置于屏幕的中央
        setDefaultCloseOperation(EXIT_ON_CLOSE);//,直接关闭应用程序

        Container contentPane = this.getContentPane();//获得JFrame的内容面板
